     ...
     ?>
       ...
       ?>
                        ...
                        <tr>
                            ...
                            <td><input id="in" type="password" name="stpass" value="<?php echo $row['password'];?>" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><select name="stream" style="width: 13em; height: 2em; font-size: 15px; ">
                                    ...
                                    <option value="CSE" <?php if($row['stream']=='CSE') echo 'selected="selected"'; ?>>
                                        CSE</option>
                                    <option value="COM" <?php if($row['stream']=='COM') echo 'selected="selected"'; ?>>
                                        COM</option>
                                    <option value="EE" <?php if($row['stream']=='EE') echo 'selected="selected"'; ?>>EE
                                    </option>
                                </select></td>
                            <td>&nbsp;</td>
                        </tr>
