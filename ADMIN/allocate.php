            ...
            include '../connection.php';
             ...
             ?> <select name="id" style="width: 10em; height: 2em; font-size: 15px;">
                 ...
                 while($row = mysqli_fetch_assoc($result))
                 {
                     $category= $row['s_id'];
                     ?>
                                <option selected="selected" value="<?php echo $category; ?>"><?php echo $category;?>
                                </option>
                                <?php
                 }
     ?>
       ...
       ?>
            <tr>
                <td colspan="2" align="center"><input type="submit" style="width: 10em;  height: 2em; font-size: 15px;"
                        name="chk" value="Check For Request" /> <br /><br /> </td>
            </tr>
            </table>
</div>
<br />
